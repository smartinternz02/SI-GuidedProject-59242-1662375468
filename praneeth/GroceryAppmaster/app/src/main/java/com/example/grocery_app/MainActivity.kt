        ...
        addFAB.setOnClickListener {
            fun openDialog(){
                ...
                addBtn.setOnClickListener {
                    ...
                    val itemNQuantity : String= itemQuantityEdt.text.toString()
                    val qty : Int = itemNQuantity.toInt()
                    val pr : Int = itemPrice.toInt()
                    if (itemName.isNotEmpty() && itemPrice.isNotEmpty() && itemNQuantity.isNotEmpty()){
